...
public class OpenApiController {
	   ...
	   String OpenSelectAll(Model model,CompanyVO vo ) {
	   ...
	   @RequestMapping("/OpenSelectOneMap.do")
	   String OpenSelectOneMap(Model model,CompanyVO vo ) {
	      model.addAttribute("m",service.selectOne(vo))  ; 
		return "/openAPI/OpenSelectOneMap.jsp";	   
	   }
	   
	   
	   
	   @RequestMapping("/EvOpenSelectAll.do")
	   String EvOpenSelectAll(Model model,EvSearchVO vo ) {
	   ...
	   String EvOpenSelectOne(Model model,EvSearchVO vo ) {
		...
		return "/openAPI/EvOpenSelectOneMap.jsp";	   
	   }
